...
| [Классификация комментариев](https://github.com/Darveivoldavara/yandex_practicum_projects/tree/main/comment_classification) | Подготовка модели, классифицирующей комментарии на нейтральные и токсичные для последующей отправки последних на модерацию | *numpy, pandas, tqdm, plotly, sklearn, tune_sklearn, lightgbm, torch, skorch, transformers* |
