...
| [Исследование объявлений о продаже квартир]() | Определение параметров для определения рыночной стоимости объектов недвижимости | *pandas, numpy, matplotlib.pyplot* |
